...
def initiate_key_derivation(target_addr, target_port):
    # Connect
    ...
    tx_sock.send_string('hey' + secret, flags=zmq.NOBLOCK)


def listen_key_derivation(addr, port):
    # Connect
...
if sys.argv[1] == 's':
    listen_key_derivation(sys.argv[2], sys.argv[3])
else:
